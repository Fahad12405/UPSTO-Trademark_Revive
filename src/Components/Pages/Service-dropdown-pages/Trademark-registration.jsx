...
import { Button, Typography, Card, CardHeader, CardMedia, CardContent, Avatar, IconButton } from '@mui/material';
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', position: 'relative', zIndex: 1, padding: '40px', borderRadius: '8px', width: '100%', maxWidth: '1200px' }}>
          <Card
            sx={{
              ...
              minHeight: { xs: 450, sm: 600 }, // Set minimum height to ensure content fits
              marginLeft: '20px',
              position: 'relative',
              zIndex: 1,
              padding: '10px',
